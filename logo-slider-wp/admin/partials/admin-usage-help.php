                ...
                <div class="meta-box-sortables ui-sortable">
                    ...
                    <div class="postbox">
                        ...
                        <div style="margin-left: -5%;">
                            ...
                            <h3 class="clear"><?php esc_html_e('Quick Usage Guidelines', 'logo-slider-wp'); ?></h3>
                            ...
                            <ol>
                                <li><?php esc_html_e('First, go to "Add New Logo" to add brand logos.', 'logo-slider-wp'); ?></li>
                                <li><?php esc_html_e('Provide the company name, URL, brand image, description, and tooltip text.', 'logo-slider-wp'); ?></li>
                                <li><?php esc_html_e('If you need to filter logo items or want to display multiple showcases, add categories and assign logo items to the desired category based on your requirements.', 'logo-slider-wp'); ?></li>
                                <li><?php esc_html_e('Now, go to "Shortcode Generator" to create your desired logo showcase.', 'logo-slider-wp'); ?></li>
                                <li><?php esc_html_e('Select either carousel or grid layout and configure your shortcode according to your needs.', 'logo-slider-wp'); ?></li>
                                <li><?php esc_html_e('Carefully read the description/instruction for each option at the bottom of the page.', 'logo-slider-wp'); ?></li>
                                <li><?php esc_html_e('Finally, use the generated shortcode in any post, page, widget, or theme to display the Logo Slider WP.', 'logo-slider-wp'); ?></li>
                            </ol>
                            <ul>
                            ...
                            <h3 class="clear"><?php esc_html_e('Upgrading to Premium Version without any data loss', 'logo-slider-wp'); ?></h3>
